// matcher v0 — shallow similarity (role/name/text), no owner. Refuted by RH1a.
...
export const engine = { id: 'matcher', version: 'v0', kind: 'shallow-similarity', capabilities: ['identity'], evaluate: ({ known, candidates }) => ({ decision: decide(known, candidates), version: 'v0' }) };
